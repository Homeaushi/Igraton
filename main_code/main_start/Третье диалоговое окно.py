...
# Текстовые сцены
scenes = [
    {"character": "Акакаий", "text": "Ты просто невероятен!"},
    {"character": "Акакий", "text": "Осталось совсем чуть-чуть..."},
    {"character": "Акакий", "text": "Финишная прямая и мы столкнемся с их боссом"},
    {"character": "Акакий", "text": "МУДРЫМ ПНЁМ"},
    {"character": "МУДРЫЙ ПЕНЬ", "text": "размечтались) мои баги уже поработили всё что у вас есть"},
    {"character": "Акакий", "text": "Ага, конечно. Он врёт. Давай покажем ему, кто тут ХАЗЯЕВА!"},
